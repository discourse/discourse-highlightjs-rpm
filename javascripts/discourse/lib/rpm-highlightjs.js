// adapted from https://github.com/highlightjs/highlightjs-rpm-specfile/blob/master/rpm-specfile.js
  ...
  return {
    ...
    contains: [
      ...
      },
      {
        className: "link",
        begin:
          /(%)(if|ifarch|ifnarch|ifos|ifnos|elif|elifarch|elifos|else|endif)/,
      },
      {
        className: "link",
        begin: /%\{_/,
